...
class T extends k {
    ...
    h(t) {
        const s = (function (t) {
            let s = ""
            for (let i in t)
                t.hasOwnProperty(i) && (s.length && (s += "&"), (s += encodeURIComponent(i) + "=" + encodeURIComponent(t[i])))
            return s
        })(t)
        return s.length ? "?" + s : ""
    }
        ...
        try {
            ...
            ;(null === (t = this.p.cookieJar) || void 0 === t || t.addCookies(i),
                ...
                (i.onreadystatechange = () => {
                    var t
                    ;(3 === i.readyState &&
                        (null === (t = this.p.cookieJar) || void 0 === t || t.parseCookies(i.getResponseHeader("set-cookie"))),
                        4 === i.readyState &&
...
class Y extends k {
    constructor(t, s) {
        ...
        ;(x(this, s),
            (this.secure = null != s.secure ? s.secure : "undefined" != typeof location && "https:" === location.protocol),
            ...
            (this.port =
                s.port || ("undefined" != typeof location && location.port ? location.port : this.secure ? "443" : "80")),
            (this.transports = []),
            (this.R = {}),
...
class tt extends Z {
    constructor(t, s = {}) {
        ...
        ;((!i.transports || (i.transports && "string" == typeof i.transports[0])) &&
            (i.transports = (i.transports || ["polling", "websocket", "webtransport"]).map((t) => X[t]).filter((t) => !!t)),
            super(t, i))
    }
}
class st extends N {
...
function lt(t, s) {
    ...
    else if ("object" == typeof t) for (const i in t) Object.prototype.hasOwnProperty.call(t, i) && (t[i] = lt(t[i], s))
    return t
}
        ...
        return (
            ...
            (function (t, s) {
                switch (t) {
                    ...
                    case yt.EVENT:
                        return (
                            Array.isArray(s) && ("number" == typeof s[0] || ("string" == typeof s[0] && -1 === dt.indexOf(s[0])))
                        )
                    case yt.ACK:
                        return Array.isArray(s)
                    case yt.CONNECT_ERROR:
...
const At = Object.freeze({ connect: 1, connect_error: 1, disconnect: 1, disconnecting: 1, newListener: 1, removeListener: 1 })
class Et extends k {
    constructor(t, s, i) {
        ;(super(),
            (this.connected = !1),
    ...
    emit(t, ...s) {
        ...
        return (
            (this.flags.volatile && !o) || (h ? (this.notifyOutgoingListeners(r), this.packet(r)) : this.sendBuffer.push(r)),
            (this.flags = {}),
            this
        )
    }
    ...
    ut(t) {
        ...
        ;(t.push((t, ...e) => {
            ...
            return (
                null !== t ? i.tryCount > this.p.retries && (this.nt.shift(), s && s(t)) : (this.nt.shift(), s && s(null, ...e)),
                (i.pending = !1),
                this.lt()
            )
        }),
...
class _t extends k {
    ...
    reconnect() {
        ...
        const t = this
        if (this.backoff.attempts >= this.Ot) (this.backoff.reset(), this.emitReserved("reconnect_failed"), (this.ht = !1))
        else {
    ...
    const i = (function (t, s = "", i) {
            ...
            ;((i = i || ("undefined" != typeof location && location)),
                ...
                "string" == typeof t &&
                    ...
                    (e = Q(t))),
                e.port ||
                    (/^(http|ws)$/.test(e.protocol) ? (e.port = "80") : /^(http|ws)s$/.test(e.protocol) && (e.port = "443")),
                (e.path = e.path || "/"))
